...
Fork the repository to your own namespace, and let us take `https://github.com/<username>/toy` as example.

Clone the repository and navigate to the root directory:

```shell
git clone git@github.com:<username>/toy.git
cd toy
```
...
```shell
git remote add upstream https://github.com/you-n-g/toy
git fetch upstream
```
...
```shell
git remote set-url --push upstream git@github.com/<username>/toy.git
```
...
```shell
origin  git@github.com:<username>/toy.git (fetch)
origin  git@github.com:<username>/toy.git (push)
upstream        https://github.com/you-n-g/toy (fetch)
upstream        git@github.com:<username>/toy.git (push)
```
